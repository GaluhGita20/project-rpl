...
<header class="header">
  ...
  <div class="header-actions">
    ...
    <div class="header-brand">
      ...
      <!-- HEADER BRAND TEXT -->
      <h1 class="header-brand-text">AyoBisa</h1>
      <!-- /HEADER BRAND TEXT -->
    </div>
    <!-- /HEADER BRAND -->
  </div>
    ...
    <nav class="navigation">
      ...
      <ul class="menu-main">
        ...
        <li class="menu-main-item">
          <!-- MENU MAIN ITEM LINK -->
          <a class="menu-main-item-link" href="{{Route('home')}}">Home</a>
          <!-- /MENU MAIN ITEM LINK -->
        </li>
        <!-- /MENU MAIN ITEM -->
        ...
        <li class="menu-main-item">
          <!-- MENU MAIN ITEM LINK -->
          <a class="menu-main-item-link" href="{{Route('mainForum')}}">Forum</a>
          <!-- /MENU MAIN ITEM LINK -->
        </li>
        <!-- /MENU MAIN ITEM -->
        ...
        <li class="menu-main-item">
          <!-- MENU MAIN ITEM LINK -->
          <a class="menu-main-item-link" href="#">News</a>
          <!-- /MENU MAIN ITEM LINK -->
        </li>
        <!-- /MENU MAIN ITEM -->
  ...
  <div class="header-actions search-bar">
    ...
    <div class="interactive-input dark">
      <input type="text" id="search-main" name="search_main" placeholder="Search here for topic forum">
    ...
    <div class="dropdown-box padding-bottom-small header-search-dropdown"> 
      ...
      <div class="dropdown-box-category">
        ...
        <p class="dropdown-box-category-title">Forum</p>
        <!-- /DROPDOWN BOX CATEGORY TITLE -->
      </div>
      <!-- /DROPDOWN BOX CATEGORY -->
      ...
      <div class="dropdown-box-list small no-scroll">
        ...
        <a class="dropdown-box-list-item" href="#">
          ...
          <div class="user-status notification">
            ...
            <!-- USER STATUS TITLE -->
            <p class="user-status-title"><span class="bold">Gempa Bumi di blablabla</span></p>
            <!-- /USER STATUS TITLE -->
          ...
          <div class="dropdown-box-list" data-simplebar>
            ...
            <div class="dropdown-box-list-item">
              ...
              <div class="user-status notification">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">Sarah Diamond</a> left a like <img class="reaction" src="asset/umum/reaction/like.png" alt="reaction-like"> reaction on your <a class="highlighted" href="profile-timeline.html">status update</a></p>
                <!-- /USER STATUS TITLE -->
            ...
            <div class="dropdown-box-list-item">
              ...
              <div class="user-status notification">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">The Green Goo</a> left a love <img class="reaction" src="asset/umum/reaction/love.png" alt="reaction-love"> reaction on your <a class="highlighted" href="profile-timeline.html">status update</a></p>
                <!-- /USER STATUS TITLE -->
      ...
      <div class="dropdown-navigation header-settings-dropdown">
        ...
        <div class="dropdown-navigation-header">
          ...
          <div class="user-status">
            ...
            <!-- USER STATUS TEXT -->
            <p class="user-status-text small"><a href="profile-timeline.html">@galuhgita</a></p>
            <!-- /USER STATUS TEXT -->
          </div>
          <!-- /USER STATUS -->
        </div>
        ...
        <!-- DROPDOWN NAVIGATION LINK -->
        <a class="dropdown-navigation-link" href="hub-profile-social.html">Forum</a>
        <!-- /DROPDOWN NAVIGATION LINK -->
