                        ...
                        <div class="form-row">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" id="register-email" name="register_email" required>
                                    {{-- <span class="text-danger">@error{'register_email'}{{$message}}@enderror</span> --}}
                                </div>
                                <!-- /FORM INPUT -->
                            </div>
                            <!-- /FORM ITEM -->
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-input">
                                    ...
                                    {{-- <span class="text-danger">@error{'register_username'}{{$message}}@enderror</span> --}}
                                </div>
                                <!-- /FORM INPUT -->
                            </div>
                            <!-- /FORM ITEM -->
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-input">
                                    ...
                                    {{-- <span class="text-danger">@error{'register_password'}{{$message}}@enderror</span> --}}
                                </div>
                                <!-- /FORM INPUT -->
                            </div>
                            <!-- /FORM ITEM -->
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-input">
                                    ...
                                    {{-- <span class="text-danger">@error{'register_password_repeat'}{{$message}}@enderror</span> --}}
                                </div>
                                <!-- /FORM INPUT -->
                            </div>
                            <!-- /FORM ITEM -->
