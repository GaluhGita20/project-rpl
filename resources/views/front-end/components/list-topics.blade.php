  ...
  <div class="section-filters-bar v7">
    ...
    <div class="section-filters-bar-actions">
      ...
      <div class="section-filters-bar-info">
        ...
        <p class="section-filters-bar-title"><a href="{{Route('mainForum')}}">Forums</a><span class="separator"></span><a href="{{Route('listTopic')}}">Peduli Lingkungan</a></p>
        <!-- /SECTION FILTERS BAR TITLE -->
      ...
      <div class="table-row mid">
        ...
        <div class="table-column padded-big-left">
          ...
          <div class="user-status">
            ...
            <!-- USER STATUS TITLE -->
            <p class="user-status-title"><a class="bold" href="#">Ananda</a></p>
            <!-- /USER STATUS TITLE -->
        
            <!-- USER STATUS TEXT -->
            <p class="user-status-text small">4 hour, 36 minutes ago</p>
            <!-- /USER STATUS TEXT -->
          </div>
          <!-- /USER STATUS -->
        </div>
        ...
        <div class="table-column">
          ...
          <div class="discussion-preview">
            ...
            <div class="discussion-preview-meta">
              ...
              <!-- DISCUSSION PREVIEW META TEXT -->
              <p class="discussion-preview-meta-text"><a href="#">Dedens</a> 5 hours ago</p>
              <!-- /DISCUSSION PREVIEW META TEXT -->
            </div>
            <!-- /DISCUSSION PREVIEW META -->
          </div>
      ...
      <div class="table-row medium">
        ...
        <div class="table-column padded-big-left">
          ...
          <div class="user-status">
            ...
            <!-- USER STATUS TITLE -->
            <p class="user-status-title"><a class="bold" href="#">Dedens</a></p>
            <!-- /USER STATUS TITLE -->
        ...
        <div class="table-column">
          ...
          <div class="discussion-preview">
            ...
            <div class="discussion-preview-meta">
              ...
              <!-- DISCUSSION PREVIEW META TEXT -->
              <p class="discussion-preview-meta-text"><a href="#">Bagus Prayogo</a> 14 hours ago</p>
              <!-- /DISCUSSION PREVIEW META TEXT -->
            </div>
            <!-- /DISCUSSION PREVIEW META -->
          </div>
        ...
        <div class="table-column">
          ...
          <div class="discussion-preview">
            ...
            <div class="discussion-preview-meta">
              ...
              <!-- DISCUSSION PREVIEW META TEXT -->
              <p class="discussion-preview-meta-text"><a href="#">Carlo</a> 6 days ago</p>
              <!-- /DISCUSSION PREVIEW META TEXT -->
            </div>
            <!-- /DISCUSSION PREVIEW META -->
          </div>
